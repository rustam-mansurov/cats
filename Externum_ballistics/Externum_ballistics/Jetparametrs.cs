...
namespace Externum_ballistics
{
    public class Jetparametrs
    {
        ...
        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Общая сила тяги реактивного двигателя")]
        public double Psigma { get; set; }

        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Сила тяги реактивного двигателя с учетом вращения")]
        ...
        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Суммарный импульс тяги двигателя")]
        public double It { get; set; }

        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Скорость горения")]
        public double u { get; set; }

        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Давление в камере сгорания")]
        public double pk { get; set; }

        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Расход продуктов горения через сопло")]
        public double G { get; set; }

        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Скорость горения в выходном сечении")]
        public double uv { get; set; }

        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Скорость звука в выходном сечении")]
        ...
        [Category("Сопло с ребрами"), DescriptionAttribute("Описание"), DisplayName("Внешнее давление")]
        public double pv { get; set; }
        #endregion
        #region Константы
        [Category("Константы"), DescriptionAttribute("Описание"), DisplayName("Высота ребер на внутренней поверхности сопла")]
        public double h { get; set; }

        [Category("Константы"), DescriptionAttribute("Описание"), DisplayName("Диаметр выходного сечения сопла")]
