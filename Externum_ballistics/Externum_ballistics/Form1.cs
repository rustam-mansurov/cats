...
namespace Externum_ballistics
{
    public partial class Form1 : Form
    {
        ...
        #region —охранение и загрузка данных
        private void jsonToolStripMenuItem_Click(object sender, EventArgs e)//—охранить данные снар€да в JSON
        {
            JsonSerializer serializer = new JsonSerializer();
            SaveFileDialog openDialog = new SaveFileDialog();
            openDialog.Filter = "‘айл данных|*.json";
        ...
        private void jsonToolStripMenuItem1_Click(object sender, EventArgs e)//«агрузить данные снар€да в JSON
        {
        ...
        private void xMLToolStripMenuItem_Click(object sender, EventArgs e)//«агрузить данные снар€да в XML
        {
            OpenFileDialog openDialog = new OpenFileDialog();
            openDialog.Filter = "‘айл данных|*.snl";
        ...
        private void начатьToolStripMenuItem_Click(object sender, EventArgs e)//Ќачать вычислени€
        {
            ...
            formsPlot4.Plot.YLabel(" ритерий устойчивости");
            formsPlot4.Refresh();
        }


        private void начальные”слови€ToolStripMenuItem_Click(object sender, EventArgs e)// «адание начальных условий
        {
        ...
        private void Form1_Load(object sender, EventArgs e)// „тение файла снар€да при запуске 
        {
        ...
        private void изменитьѕараметрыToolStripMenuItem_Click(object sender, EventArgs e)
        {
            propertyGrid1.SelectedObject = OFM29;
        }
