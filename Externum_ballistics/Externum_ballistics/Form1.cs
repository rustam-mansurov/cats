...
namespace Externum_ballistics
{
    public partial class Form1 : Form
    {
        ...
        private void сохранитьНачальныеПараметрыToolStripMenuItem_Click(object sender, EventArgs e)
        {
            JsonSerializer serializer = new JsonSerializer();
            SaveFileDialog openDialog = new SaveFileDialog();
            openDialog.Filter = "Файл данных|*.json";
        ...
        private void сохранитьНачальныеПараметрыToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            JsonSerializer serializer = new JsonSerializer();
            SaveFileDialog openDialog = new SaveFileDialog();
            openDialog.Filter = "Файл данных|*.json";
