...
namespace Externum_ballistics
{
    public partial class Form1 : Form
    {
        ...
        private void начальныеПараметрыРеактивногоДвигателяToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            jetparametrs.pk = solver.pk(jetparametrs.pT, jetparametrs.u1, jetparametrs.Sg, 0.98, 287, jetparametrs.Tk, 0.98, jetparametrs.Skr, jetparametrs.nu)/1e+6;// Давление в камере
            ...
            jetparametrs.pv = solver.pv(jetparametrs.pk, jetparametrs.k, jetparametrs.lambda)/1e+6;// Внешнее давление
